idleStatic = {
	...
	{id="3416313250",	name="WriteBlackboard",	pid="160531963",	args={val=RUN, key="moveMode"}},
...
wanderStatic = {
	...
	{id="1848176669",	name="WriteBlackboard",	pid="1736612732",	args={val=RUN, key="moveMode"}},
	...
	{id="2664305160",	name="WriteBlackboard",	pid="446627907",	args={val=WALK, key="moveMode"}},
