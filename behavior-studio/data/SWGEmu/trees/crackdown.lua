...
idleCrackdown = {
	...
	{id="2472779767",	name="WriteBlackboard",	pid="3071138585",	args={val=RUN, key="moveMode"}},
	{id="3225520752",	name="WriteBlackboard",	pid="3326622834",	args={val=WALK, key="moveMode"}},
...
rootCrackdown = {
	...
	{id="300809128",	name="WriteBlackboard",	pid="1092511889",	args={val=RUN, key="moveMode"}},
	{id="2814641736",	name="WriteBlackboard",	pid="2411220363",	args={val=WALK, key="moveMod"}},
