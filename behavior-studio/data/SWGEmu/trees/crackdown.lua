awareCrackdown = {
	...
	{id="18871188",	name="Sequence",	pid="694324695"},
...
idleCrackdown = {
	...
	{id="433044007",	name="CheckFollowState",	pid="2567586958",	args={condition=WATCHING}},
	...
	{id="300585033",	name="CheckFollowState",	pid="2821616316",	args={condition=WATCHING}},
	...
	{id="89199125",	name="SetFollowState",	pid="3420905314",	args={state=PATROLLING}},
	{id="2166615744",	name="AlwaysFail",	pid="3420905314"},
	{id="1840242268",	name="Sequence",	pid="2166615744"},
	{id="257849292",	name="Not",	pid="1840242268"},
	{id="3784279889",	name="If",	pid="257849292"},
	{id="4166375638",	name="CheckHasPatrol",	pid="3784279889"},
	{id="3125047964",	name="Not",	pid="1840242268"},
	{id="2832653366",	name="If",	pid="3125047964"},
	{id="1213774863",	name="CheckIsStationary",	pid="2832653366"},
	{id="2865816838",	name="GeneratePatrol",	pid="1840242268",	args={distFromHome=15.0, numPoints=5}},
	...
	{id="3855939006",	name="CheckFollowState",	pid="1931706343",	args={condition=PATROLLING}},
...
lookCrackdown = {
	...
	{id="1956271224",	name="CheckFollowState",	pid="4006686023",	args={condition=OBLIVIOUS}},
	{id="3477974716",	name="If",	pid="3613339524"},
	{id="1793565763",	name="CheckFollowState",	pid="3477974716",	args={condition=WATCHING}},
	{id="3305550153",	name="If",	pid="3613339524"},
	{id="1751494098",	name="CheckFollowState",	pid="3305550153",	args={condition=FOLLOWING}},
	...
	{id="3588181178",	name="SetFollowState",	pid="526604206",	args={state=FOLLOWING}},
